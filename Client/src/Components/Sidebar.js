...
import { Clock, Lock, MessageCircle, Newspaper, Pencil, Settings, Wallet, Menu, X } from "lucide-react";
...
const Sidebar = () => {
    ...
    return (
        <div className="app-container">
            ...
            {/* Sidebar */}
            <div className={`usersidebar ${isSidebarOpen ? "open" : ""} ${isClosing ? "closing" : ""}`}>
            ...
            {showPopup2 && (
                <div className="popup2" aria-hidden={!showPopup2} aria-modal={showPopup2}>
                    <div className="aria-modal2">
                        <button className="close-button" onClick={togglePopup2}>&times;</button>
                        <div className="calendar-container">
                            ...
                            <Calendar variant="filled" value={date} onChange={(e) => setDate(e.value)} inline showButtonBar className="calender calendar-large" />
